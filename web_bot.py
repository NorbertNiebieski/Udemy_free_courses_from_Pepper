...
class WebBot:
    def __init__(self, udemy_login="", udemy_password="", pepper_login="", pepper_password="",
        ...
        option.add_argument("user-data-dir=" + path_to_chrome_profile)
    ...
    def log_to_pepper_account(self):
        ...
        try:
            self.is_logged_to_pepper = True
            return pepper_handling.log_to_pepper_account(self, self.pepper_login, self.pepper_password, self.sleep_time)
        except:
            self.is_logged_to_pepper = False
            return False
    ...
    def taking_links_to_udemy_from_pepper_promotion(self, promotion_link):
        return pepper_handling.find_udemy_promotions_on_pepper(self, promotion_link)
