...
class MyTestCase(unittest2.TestCase):
    ...
    def setUp(cls):
        ...
        # starting bot
        try:
            cls.__my_bot = web_bot.WebBot(cls.udemy_login, cls.udemy_password, cls.pepper_login, cls.pepper_password,
                                          cls.path_to_chrome_profile, cls.sleep_time, "tests.py")
            log.log_and_print("info", "Bot lunch correctly!")
        except Exception as error:
            log.log_and_print("error", "Something went wrong with lunching bot", error)
            return -1
    ...
    def test_logging_to_pepper(self):
        ...
        try:
            ...
            log.log_and_print("error", "Error when logging to pepper account", error)
    ...
    def test_logging_to_udemy(self):
        ...
        try:
            ...
            log.log_and_print("error", "Error when logging to udemy account", error)
